    ...
    <div style={{ height:'100vh', display:'flex', alignItems:'center', justifyContent:'center', background:'var(--bg)' }}>
      <div style={{ width:380 }}>
        <div style={{ textAlign:'center', marginBottom:32 }}>
          ...
          <div style={{ fontSize:13, color:'var(--text2)' }}>Войдите в свой аккаунт</div>
        </div>
        ...
        <div style={{ textAlign:'center', marginTop:16, fontSize:13, color:'var(--text2)' }}>
          Нет аккаунта? <Link to="/register" style={{ color:'var(--green)', textDecoration:'none' }}>Зарегистрироваться</Link>
        </div>
      </div>
    </div>
  )
